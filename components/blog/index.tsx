    ...
    <div>
      <div className="relative my-14 md:pt-24">
        ...
        <div className="opacity-70 max-w-2xl mx-auto mt-2 text-gray-500 dark:text-neutral-400">
          ...
          using pre-built UI parts, custom components, and layouts using
          Tailwind CSS.
        </div>
      </div>
        ...
        {[
          {
            ...
            desc: "Create stunning websites that adapt seamlessly to different screen sizes and devices.",
          },
          {
            title: "Extensive Component Library",
            desc: "Choose from a vast collection of pre-built components to accelerate your application development.",
          },
          {
            title: "Customizable Styles",
            desc: "Easily customize the look and feel of your application with our flexible styling options.",
          },
          {
            title: "Accessibility Ready",
            desc: "Ensure your application is accessible to all users, regardless of their abilities or devices.",
          },
          {
            title: "Cross-Browser Compatibility",
            desc: "Rest assured that your application will work flawlessly across all major browsers.",
          },
          {
            title: "Optimized Performance",
            desc: "Deliver fast-loading and smooth user experiences with our performance-optimized codebase.",
          },
        ].map((feature, idx) => (
          <div
            key={idx}
