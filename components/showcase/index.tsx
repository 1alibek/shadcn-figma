...
const Showcase = () => {
  ...
  {[
    { name: "Tailwind", desc: "Tailwind dec" },
    { name: "Stripe", desc: "Stripe dec" },
    { name: "NextAuth", desc: "NextAuth dec" },
    { name: "Supabase", desc: "Supabase dec" },
    { name: "Mailgun", desc: "Mailgun dec" },
    { name: "NextJS", desc: "NextJS dec" },
  ].map((tool, idx) => (
    <div
      key={idx}
